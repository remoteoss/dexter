...
// ValidFunctionName reports whether name is a valid Elixir function name.
func ValidFunctionName(name string) bool { return isValidFunctionName(name) }

// ValidModuleName reports whether name is a valid fully-qualified module name.
func ValidModuleName(name string) bool { return isValidModuleName(name) }

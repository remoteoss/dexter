...
// `--- a/oldName` / `+++ b/newName`. It returns "" when the texts are equal.
// The output is a valid patch: `git apply` reproduces newText exactly,
// including missing trailing newlines.
